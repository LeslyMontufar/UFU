...
\centering
\def\arraystretch{1.38}
\caption{Tensões de polarização do amplificador diferencial.} \label{ganho}
\begin{tabular}{|c|c|c|} 
\hhline{~--|}
\multicolumn{1}{c|}{}                            & {\cellcolor[rgb]{0.937,0.937,0.937}}\begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.937,0.937,0.937}}c@{}}\textbf{Ganho Diferencial}\\\textbf{Saída Simples}\end{tabular} & {\cellcolor[rgb]{0.937,0.937,0.937}}\begin{tabular}[c]{@{}>{\cellcolor[rgb]{0.937,0.937,0.937}}c@{}}\textbf{Ganho Diferencial}\\\textbf{Saída Diferencial}\end{tabular}  \\ 
\hline
...
Ademais, a simulação permitiu recolher dados analógicos das saídas $V_{out, 1}$ e $V_{out, 2}$, que são vistos nas Figuras \ref{sim:out1} e \ref{sim:out2}.
