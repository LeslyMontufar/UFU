...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g1,x))]);
ylabel('g_1(t)');
xlabel('t');
grid on;
...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g2,x))]);
ylabel('g_2(t)');
xlabel('t');
grid on;
...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g3,x))]);
ylabel('g_3(t)');
xlabel('t');
grid on;
...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g4,x))]);
ylabel('g_4(t)');
xlabel('t');
grid on;
...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g5,x))]);
ylabel('g_5(t)');
xlabel('t');
grid on;
...
ylim([-1.5 1.5]);
title(['\rho = ' num2str(correlacao(g6,x))]);
ylabel('g_6(t)');
xlabel('t');
grid on;
