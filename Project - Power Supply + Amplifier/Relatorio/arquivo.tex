...
\multicolumn{1}{|c|}{}                              & $1k8 \Omega$ - 5W      & 2                   & $2\times 1,25 = 2,50$        & \multicolumn{1}{c|}{Descarga do capacitor} \\ \hline
...
\def\arraystretch{1.28}
\centering
\caption{Componentes e orçamento do amplificador.}
\label{amp:componentes}
\resizebox{\textwidth}{!}{%
\begin{tabular}{|c|c|c|c|c|}
\hline
\textbf{Componente}           & \textbf{Especificação} & \textbf{Quantidade} & \textbf{Preço} & \textbf{Descrição} \\ \hline
\multirow{7}{*}{Capacitores}  & $15 \mu F$             & 1                   &                & C1                 \\ \cline{2-5} 
                              & $200 \mu F$            & 1                   &                & C2                 \\ \cline{2-5} 
                              & $68 p F$               & 1                   &                & C3                 \\ \cline{2-5} 
                              & $20 \mu F$             & 1                   &                & C4                 \\ \cline{2-5} 
                              & $220 \mu F$            & 1                   &                & C5                 \\ \cline{2-5} 
                              & $100 nF$               & 1                   &                & C6                 \\ \cline{2-5} 
                              & $1000 \mu F$           & 1                   &                & C7*                \\ \hline
\multirow{12}{*}{Resistores}  & $2M7 \Omega$           & 1                   &                & R1                 \\ \cline{2-5} 
                              & $150k \Omega$          & 1                   &                & R2                 \\ \cline{2-5} 
                              & $33k \Omega$           & 1                   &                & R3                 \\ \cline{2-5} 
                              & $1k \Omega$            & 3                   &                & R4, R11, R14       \\ \cline{2-5} 
                              & $18k \Omega$           & 2                   &                & R5, R7             \\ \cline{2-5} 
                              & $47k \Omega$           & 1                   &                & R6                 \\ \cline{2-5} 
