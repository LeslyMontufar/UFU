...
\end{figure}
Do circuito esquemático Figura \ref{estrela:calculo}, considera-se primeiro sequência de fases positiva (abc), com $V_{AB}$ na referência tem-se os resultados mostrados a seguir.
