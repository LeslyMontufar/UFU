...
\centering
\captionsetup{font=scriptsize}
\includegraphics[width=13.5cm]{watt}
...
\centering
\captionsetup{font=scriptsize}
\includegraphics[width=13.5cm]{sim1}
\caption{Circuito referente à montagem em estrela.}
\label{estrela:circuito}
\end{figure}
Ainda fazendo os cálculos, de tensão e corrente tem-se a Figura \ref{estrela:calculo}.

\begin{figure}[H]
\centering
\captionsetup{font=scriptsize}
\includegraphics[width=13.5cm]{sim1}
\caption{Circuito referente à montagem em estrela com cálculos.}
\label{estrela:calculo}
\end{figure}
...
\centering
\captionsetup{font=scriptsize}
\includegraphics[width=13.5cm]{fp}
...
\multicolumn{1}{|c|}{\multirow{2}{*}{Estrela}} & ABC ($V_{AB}$) & 99,46       & 0,501       & 0,543        & 57,11               & 0,890                     & 0,504                     & 44,35       & 25,114      \\ \cline{2-10} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Como extamente quer-se o diagrama fasorial? 
