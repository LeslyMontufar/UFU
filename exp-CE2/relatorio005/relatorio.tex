...
\begin{table}[H]\small
\centering
\caption{Comparativo entre potências experimentais a partir das medições nos wattímetros, e experimental no \emph{Kron} e teórico, para configuração delta ABC.}
\label{m1:comp:potencias:w}
\begin{tabular}{c|c|c|}
\cline{2-3}
                                                                                                       & $P_{T}$ (W) & $Q_{T}$ (VAr) \\ \hline
